                    ...
                    <div className="row">
                        <div className="col-lg-8 offset-lg-2">
                            <div className="content text-center">
                                ...
                                <li><FiUser /><a>{data.author}</a></li>
                                    {/* <li><FiUser /><a href={process.env.PUBLIC_URL + `/archive/${slugify(data.author)}`}>{data.author}</a></li> */}
                                    <li><FiCalendar />{data.date}</li>
                                </ul>
                                <div className="thumbnail alignwide mt--60">
                                    <img className="w-100 radius" src={`/${data.largeImage}`} alt="Blog Images" />
                                </div>
                            </div>
                        </div>
                    </div>
