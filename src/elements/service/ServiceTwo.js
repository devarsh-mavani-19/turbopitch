                        ...
                        <div className={`card-box ${cardStyle} ${textAlign}`}>
                            <div className="inner">
                                ...
                                <div className="content">
                                    <h4 className="title mb--20"><a href="#service" dangerouslySetInnerHTML={{__html: val.title}}></a></h4>
                                    <p className="description b1 color-gray mb--0" dangerouslySetInnerHTML={{__html: val.description}}></p>
                                    <a className="btn-default btn-small btn-border" href="#service">Read More</a>
                                </div>
                            </div>
                        </div>
                    </ScrollAnimation>
