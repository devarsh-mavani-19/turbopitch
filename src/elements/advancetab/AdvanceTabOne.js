                            ...
                            <TabList className="tab-button-list">
                                <Tab>
                                    <div className="tab-button">
                                        ...
                                        <p className="description">Use this tool to generate Cover Letter for your next freelance gig.</p>
                                    </div>   
                                </Tab>
                                <Tab>
                                    <div className="tab-button">
                                        <h4 className="title">Pitch Generator.</h4>
                                        <p className="description">Create an effective freelance pitch using A.I.</p>
                                    </div>   
                                </Tab>
                                {/* <Tab>
                                    <div className="tab-button">
                        ...
                        <div className="advance-tab-content advance-tab-content-1">
                                ...
                                <div className="tab-content">
                                    <div className="inner">
                                        <div className="thumbnail">
                                            <img src="./images/tab/tab_cv.png" alt="Corporate Images" />
                                        </div>
                                    </div>
                                </div>
                            </TabPanel>
                            ...
                            <TabPanel>
                                <div className="tab-content">
                                    <div className="inner">
                                        <div className="thumbnail">
                                            <img src="./images/tab/tab_pitch.png" alt="Corporate Images" />
                                        </div>
                                    </div>
                                </div>
                            </TabPanel>
