...
import { FiFacebook, FiTwitter, FiInstagram, FiLinkedin, FiDribbble } from "react-icons/fi";
                            ...
                            <div className="col-lg-2 col-md-6 col-sm-6 col-12">
                                <div className="rn-footer-widget">
                                    <div className="widget-menu-top">
                                        ...
                                        <div className="inner">
                                            <ul className="footer-link link-hover">
                                                {footerIntemTwo.quicklink.map((data, index) => (
                                                    <li key={index}><a href={`${data.url}`}>{data.text}</a></li>
                                                ))}
                                            </ul>
                                        </div>
                                ...
                                <div className="rn-footer-widget">
                                    ...
                                    <div className="inner">
                                        ...
                                        <ul className="social-icon social-default justify-content-start">
                                            <li><a href="https://www.facebook.com/jsgdevelopers/"><FiFacebook /></a></li>
                                            <li><a href="https://dribbble.com/JSGDevelopers"><FiDribbble /></a></li>
                                            <li><a href="https://www.instagram.com/jsg_developers/"><FiInstagram /></a></li>
                                            <li><a href="https://www.linkedin.com/company/jsg-developers/"><FiLinkedin /></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
