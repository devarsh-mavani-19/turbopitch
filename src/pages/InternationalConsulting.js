                            ...
                            <div className="col-lg-12">
                                <div className="inner text-center">
                                    ...
                                    <div className="button-group">
                                        <a className="btn-default btn-medium btn-icon" href="#">Purchase Now <i className="icon"><FiArrowRight /></i></a>
                                        <a className="btn-default btn-medium btn-border btn-icon" href="#">Contact Us <i className="icon"><FiArrowRight /></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
