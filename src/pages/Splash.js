                            ...
                            <div className="col-lg-12">
                                <div className="inner text-center">
                                    ...
                                    <h1 className="title display-two">
                                        Do you struggle to land deals? <br />
                                        <span className="theme-gradient">AI </span>&nbsp;Build
                                        {/* <span className="theme-gradient">Winning Pitches</span> */}
                                        <br />
                                        Winning <span className='theme-gradient'>Pitches</span>
                                    </h1>
                            ...
                            {Demo.map((data, index) => (
                                <div className="col-lg-4 col-md-6 col-12 mt--40" key={index}>
                                    <div className="single-demo">
                                        ...
                                        <h4 className="title"><a href={`${data.Url}`}>{data.Title}</a> </h4>
                                    </div>
                                </div>
                            ))} 
                        </div>
